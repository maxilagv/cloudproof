...
3. Todo hallazgo bloqueante debe ser reproducible localmente vía `cloudproof reproduce <id>`.
...
CloudProof Restricted Use License (ver [LICENSE](./LICENSE)), que limita el uso
a CloudProof como producto terminado y prohíbe redistribución, obras derivadas
